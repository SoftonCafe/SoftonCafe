  ...
  const categories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Plus de Salsa Premium', description: 'Plus de sirope', price: '0.50€' },
        { name: 'Plus de Toping', description: 'Plus de Toping', price: '0.50€' },
        { name: 'Plus de Nata Montada', description: 'Plus de Nata', price: '0.50€' },
        { name: 'Plus de Crema de Helado', description: 'Plus de Bola de Helado', price: '1€' },
    ...
    },
    {
      ...
      color: '#b8a99a',
      items: [
        { name: 'pollo tikka masala', description: 'Tapa pollo tikka masala', price: '3.50€' },
        { name: 'Albondigas en salsa', description: 'Tapa Albondigas en salsa', price: '3.50€' },
        { name: 'Magra al ajillo', description: 'Tapa Magra al ajillo', price: '3.50€' },
        { name: 'Pollo al Curry', description: 'Tapa Pollo al Curry', price: '3.50€' },
        { name: 'Pincho de Donosti', description: 'Tapa Pincho de Donosti', price: '2.50€' },
        { name: 'carrillera', description: 'Tapa carrillera', price: '4.50€' },
        { name: 'calamar', description: 'Tapa calamar', price: '4.30€' },
        ...
        { name: 'Ensaladilla', description: 'Plato ensaladilla', price: '2.50€' },
